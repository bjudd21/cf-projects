<%@ Page Title="Property Management - Tenants" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="Tenants.aspx.cs" Inherits="_Default" %>
...
<td>
 <table width="900">
    <tr>
    <td align="left" style="font-size:14px; font-weight:bold;"> Tenants
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <rad:GridBoundColumn   HeaderText="Status" UniqueName="column" DataField="Status" >    
        </rad:GridBoundColumn >
